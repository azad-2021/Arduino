...
void handleSubmit() { //dispaly values and write to memmory
  String response = "<p>The Drum Level is ";
  response += server.arg("drum");
  response += "<br>";
  response += "And the O2 is ";
  response += server.arg("O2");
  response += "<br>";
  response += "And the SHS Temp is ";
  response += server.arg("shs_temp");
  response += "<br>";
  response += "And the SHS Pressure is ";
  response += server.arg("shs_prs");
  response += "<br>";
  response += "And the Furnace 1 Temp is ";
  response += server.arg("fr1_temp");
  response += "<br>";
  response += "And the Furnace 2 Temp is ";
